...
### 3.5 爬虫模块 (Crawler Modules)

#### 3.5.1 竞赛爬虫 (Contest Crawler)
- **职责**: 定期从 Codeforces 和 LeetCode 抓取最新的竞赛信息
- **技术**: C++, httplib (SSL), jsoncpp
- **存储**: MySQL `contests` 表 + Redis 缓存
- **运行模式**: 守护进程，定时执行
